...
export default async function decorate(block) {
  ...
  events.on('pdp/data', (data) => {
    ...
    // MS Motorservice PDP extras: manufacturer branding + availability/notify
...
/* ---------------------------------------------------------------------------
 * MS Motorservice – PDP extras
 * 1) Manufacturer logo (own brands) vs. text label (third-party brands)
...
const MS_OWN_BRANDS = {
  kolbenschmidt: '#0f72b5',
  pierburg: '#0f72b5',
  bf: '#00406e',
  'trw engine components': '#00406e',
  'turbo by intec': '#d10019',
  msi: '#0f72b5',
};
