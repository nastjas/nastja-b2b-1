 ...
 *
 * Provides a full, realistic MS Motorservice dataset for demos when a live
...
const DEMO_LOCATIONS = [
  { company: 'Becker Großhandel GmbH', city: 'München' },
  { company: 'Becker Großhandel GmbH', city: 'Hamburg' },
  { company: 'Becker Großhandel GmbH', city: 'Köln' },
  { company: 'Becker Großhandel GmbH', city: 'Stuttgart' },
  { company: 'Becker Großhandel GmbH', city: 'Frankfurt' },
  { company: 'Becker Großhandel GmbH', city: 'Berlin' },
];
...
export function getDemoDashboardData(identity) {
  const customerIdentity = {
    firstname: identity?.firstname || 'Lisa',
    lastname: identity?.lastname || 'Becker',
    email: identity?.email || 'lisa.becker@becker-grosshandel.de',
  };
  ...
  // Force a visible low-stock alert on the turbocharger line.
  const lowIdx = stockData.findIndex((p) => p.sku === 'MS-TC-172090');
